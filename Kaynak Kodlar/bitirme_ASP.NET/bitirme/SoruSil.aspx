<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SoruSil.aspx.cs" Inherits="SoruSil" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Soru silme sayfasý</title>
</head>
<body>
                    ...
                    <td>
                        <asp:Panel ID="panel" runat="server" Height="36px" Width="255px">
                            ...
                            <asp:Panel ID="Panel2" runat="server" Height="15px" Width="235px">
                                Soru:
                                <asp:TextBox ID="soru" runat="server" BorderWidth="1px" Columns="6" Enabled="False"
                                    EnableViewState="False" Height="70px" MaxLength="100" Rows="6" TextMode="MultiLine"
                                    Width="211px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                                        runat="server" ControlToValidate="soru" ErrorMessage="*" Font-Size="Medium"></asp:RequiredFieldValidator></asp:Panel>
                            <br />
                            ...
                            <asp:Panel ID="Panel4" runat="server" Height="15px" Width="235px">
                                ...
                                <asp:TextBox ID="gnot" runat="server" Columns="6" Enabled="False" EnableViewState="False"
                                    Height="70px" MaxLength="100" TextMode="MultiLine" Width="211px"></asp:TextBox></asp:Panel>
                            <br />
                            <asp:Panel ID="Panel5" runat="server" Height="15px" Width="235px">
                                Kullanýcý için not: (opsiyonel)
                                <asp:TextBox ID="knot" runat="server" Enabled="False" EnableViewState="False" Height="70px"
                                    MaxLength="100" TextMode="MultiLine" Width="211px"></asp:TextBox></asp:Panel>
                            <br />
                            <asp:Button ID="sil" runat="server" OnClick="sil_Click" Text="Sil" />
                            &nbsp; &nbsp; &nbsp;&nbsp;
                        </asp:Panel>
                    </td>
                    <td valign="top">
